...
<body>
    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-header">
            ...
            <span class="role-badge role-<?php echo strtolower($app->getUserRole()); ?>">
    ...
    <script>
    // Variables globales
    // Normalize role to lowercase and trim so it matches menuConfig keys
    const userRole = '<?php echo addslashes(strtolower(trim($app->getUserRole()))); ?>';
    ...
    // Debug: log effective role and available menu keys (temporary)
    console.log('DEBUG: userRole=', userRole, 'menuConfigKeys=', Object.keys(menuConfig));
        ...
        function generateSidebarMenu() {
            ...
            // If no menu items were generated, show a visible debug message so user can see the effective role
            if (menuItems.length === 0) {
                const warnLi = document.createElement('li');
                warnLi.className = 'sidebar-item';
                warnLi.innerHTML = `<a class="sidebar-link text-danger">No hay elementos de menú para el rol: <strong>${userRole}</strong></a>`;
