        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="badge bg-warning text-dark fs-6">
                    ...
                    {{ $usuarios_pendientes ?? 0 }} pendientes
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0">
                    ...
                    <tbody id="pendientesTableBody">
                        @forelse($usuarios_pendientes_lista ?? [] as $usuario)
                        <tr>
                            <td>
                            ...
                            <td>{{ 'No registrada' }}</td>
                            <td>
                                <button class="btn btn-sm btn-success me-1" title="Aprobar usuario" onclick="aprobarUsuario({{ $usuario->id }})">
                                    <i class="fas fa-check"></i>
                                </button>
                                <button class="btn btn-sm btn-danger me-1" title="Rechazar usuario" onclick="rechazarUsuario({{ $usuario->id }})">
                                    <i class="fas fa-times"></i>
                                </button>
                                <button class="btn btn-sm btn-info" title="Ver detalles" onclick="verDetalles({{ $usuario->id }})">
