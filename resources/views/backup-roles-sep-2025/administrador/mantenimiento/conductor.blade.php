                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody id="conductoresTableBody">
                        ...
                        <tr>
                            ...
                            <td class="{{ $conductor->fecha_vencimiento && \Carbon\Carbon::parse($conductor->fecha_vencimiento)->lt(now()) ? 'text-danger' : '' }}">
                                <strong>
                                    @if($conductor->fecha_vencimiento)
                                        {{ \Carbon\Carbon::parse($conductor->fecha_vencimiento)->format('d/m/Y') }}
                                    @else
                                        No especificada
                                    @endif
                                </strong>
