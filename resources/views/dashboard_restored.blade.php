...
@section('title', 'DRTC Apurímac - Sistema Unificado')
            ...
            <div class="card bg-drtc-orange text-white">
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col">
                            <h2 class="mb-1">Bienvenido, {{ $user->username }}</h2>
                            <p class="mb-0">
                                <span class="role-badge {{ $role }}-badge text-white">
                                    {{ ucfirst($role) }}
                                </span>
            ...
            <div class="col-md-6 mb-3">
                <div class="card h-100 border-danger">
                    <div class="card-body text-center">
                        ...
                        <p class="card-text">Panel de control avanzado</p>
                        <a href="{{ route('admin.super.index') }}" class="btn btn-danger">Acceder</a>
                    </div>
                </div>
            </div>
        </div>
...
<div id="modules-container" style="display: none;">
    ...
    <div id="module-gestionar-usuarios" class="module-content">
        <div class="container-fluid">
            ...
            <hr>
            @include('partials.modulos.gestionar-usuarios')
        </div>
    </div>
    ...
    <div id="module-aprobar-usuarios" class="module-content">
        <div class="container-fluid">
            ...
            <hr>
            @include('partials.modulos.aprobar-usuarios')
        </div>
    </div>
    ...
    <div id="module-infracciones" class="module-content">
        <div class="container-fluid">
            ...
            <hr>
            @include('partials.modulos.infracciones')
        </div>
    </div>
    ...
    <div id="module-mantenimiento-conductores" class="module-content">
        <div class="container-fluid">
            ...
            <hr>
            @include('partials.modulos.mantenimiento-conductores')
        </div>
    </div>
    ...
    <div id="module-mantenimiento-inspectores" class="module-content">
        <div class="container-fluid">
            ...
            <hr>
            @include('partials.modulos.mantenimiento-inspectores')
        </div>
    </div>
</div>
