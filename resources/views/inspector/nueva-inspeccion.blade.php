    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form id="nuevaInspeccionForm" method="POST" action="{{ route('inspector.nueva-inspeccion.store') }}">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="d-flex justify-content-between">
                                    <a href="{{ route('inspector.dashboard') }}" class="btn btn-secondary">
    ...
    $('#nuevaInspeccionForm').on('submit', function(e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                setTimeout(() => {
                    window.location.href = '{{ route("inspector.inspecciones") }}';
                }, 2000);
            }
        });
    });
