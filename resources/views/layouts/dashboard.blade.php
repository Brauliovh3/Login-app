        ...
        <ul class="sidebar-nav">
            ...
            @auth
                @if(auth()->user()->role == 'administrador')
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin.mantenimiento-inspectores') }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin.mantenimiento-conductores') }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin.gestionar-usuarios') }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin.aprobar-usuarios') }}">
                ...
                @elseif(auth()->user()->role == 'fiscalizador')
                    ...
                    <li class="nav-item dropdown-hover">
                        <a class="nav-link dropdown-main" href="{{ route('fiscalizador.actas-contra') }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('fiscalizador.empresas') }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('fiscalizador.calendario') }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('fiscalizador.inspecciones') }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('fiscalizador.carga-paga') }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('fiscalizador.consultas') }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('fiscalizador.reportes') }}">
                ...
                @elseif(auth()->user()->role == 'ventanilla')
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('ventanilla.nueva-atencion') }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('ventanilla.tramites') }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('ventanilla.consultar') }}">
                            <i class="fas fa-fw fa-search"></i>
                ...
                @elseif(auth()->user()->role == 'inspector')
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('inspector.generar-acta-inspector') }}">
