<?php $__env->startSection('title', 'Dashboard - Administrador DRTC Apurímac'); ?>
        ...
        --drtc-dark-orange:                         <div class="col-md-6 col-lg-4">
                            <div class="card h-100 shadow-sm border-0">
                                <div class="card-body text-center">
                                    ...
                                    <a href="<?php echo e(route('fiscalizador.actas-contra')); ?>" class="btn btn-primary">Ver Actas</a>
                                </div>
                            </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col">
                        ...
                        <div class="d-flex align-items-center text-warning">
                            ...
                            <span class="me-3">Administrador: <?php echo e(Auth::user()->name); ?></span>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h2 class="mb-0 fw-bold"><?php echo e($stats['total_usuarios'] ?? 0); ?></h2>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h2 class="mb-0 fw-bold"><?php echo e($stats['usuarios_activos'] ?? 0); ?></h2>
                            <small class="opacity-75"><?php echo e(round((($stats['usuarios_activos'] ?? 0) / max(1, $stats['total_usuarios'] ?? 1)) * 100)); ?>% del total</small>
                        </div>
                        <div class="align-self-center">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h2 class="mb-0 fw-bold"><?php echo e($stats['usuarios_pendientes'] ?? 0); ?></h2>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h2 class="mb-0 fw-bold"><?php echo e($stats['total_roles'] ?? 0); ?></h2>
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="card h-100 border-drtc-orange">
                                <div class="card-body text-center">
                                    ...
                                    <a href="<?php echo e(route('users.index')); ?>" class="btn bg-drtc-orange text-white">Gestionar</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <div class="card h-100 border-warning">
                                <div class="card-body text-center">
                                    ...
                                    <?php if(($stats['usuarios_pendientes'] ?? 0) > 0): ?>
                                        <span class="badge bg-danger mb-2"><?php echo e($stats['usuarios_pendientes']); ?> pendientes</span>
                                    <?php endif; ?>
                                    <br>
                                    <a href="<?php echo e(route('admin.users.approval')); ?>" class="btn btn-warning">
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="card h-100 border-danger">
                                <div class="card-body text-center">
                                    ...
                                    <a href="<?php echo e(route('infracciones.index')); ?>" class="btn btn-danger">Ver Infracciones</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <div class="card h-100 border-info">
                                <div class="card-body text-center">
                                    ...
                                    <div class="btn-group w-100" role="group">
                                        <a href="<?php echo e(route('admin.mantenimiento.conductor')); ?>" class="btn btn-outline-info btn-sm">Conductores</a>
                                        <a href="<?php echo e(route('admin.mantenimiento.fiscal')); ?>" class="btn btn-outline-info btn-sm">Inspectores</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
        ...
        async function callReset(force) {
                ...
                try {
                        ...
                        const res = await fetch('<?php echo e(route('admin.actas.reset-autoincrement')); ?>', {
                                method: 'POST',
                                headers: {
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Login-app\resources\views\backup-roles-sep-2025\administrador\dashboard.blade.php ENDPATH**/ ?>