                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover table-fixed align-middle">
                        ...
                        <?php $__currentLoopData = $conductores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td class="fw-semibold"><?php echo e($c->nombre_completo ?? trim(($c->nombres ?? '') . ' ' . ($c->apellidos ?? ''))); ?></td>
                                <td><?php echo e($c->dni ?? ($c->documento ?? '-')); ?></td>
                                <td><?php echo e($c->licencia ?? ($c->numero_licencia ?? '-')); ?></td>
                                <td>
                                    <span class="badge bg-<?php echo e(($c->estado ?? ($c->estado_licencia ?? 'inactivo')) === 'activo' ? 'success' : 'secondary'); ?>"><?php echo e($c->estado ?? ($c->estado_licencia ?? 'inactivo')); ?></span>
                                </td>
                                <td class="text-end">
                                    <!-- No se muestra el id como columna visible; se puede usar para acciones JS/data-attrs si es necesario -->
                                    <button class="btn btn-sm btn-outline-primary btn-editar" data-id="<?php echo e($c->id); ?>" data-nombres="<?php echo e($c->nombres ?? ''); ?>" data-apellidos="<?php echo e($c->apellidos ?? ''); ?>" data-dni="<?php echo e($c->dni ?? ''); ?>" data-licencia="<?php echo e($c->licencia ?? ''); ?>">Editar</button>
                                    <button class="btn btn-sm btn-outline-danger btn-eliminar" data-id="<?php echo e($c->id); ?>">Eliminar</button>
                                </td>
                            </tr>
...
<?php /**PATH C:\xampp\htdocs\Login-app\resources\views\backup-roles-sep-2025\administrador\mantenimiento\conductores.blade.php ENDPATH**/ ?>