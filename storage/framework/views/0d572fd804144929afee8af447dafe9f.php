<?php $__env->startSection('title', 'Dashboard - Ventanilla DRTC Apurímac'); ?>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col">
                        ...
                        <div class="d-flex align-items-center text-drtc-navy">
                            ...
                            <span class="me-3">Operador: <?php echo e(Auth::user()->name); ?></span>
                            <i class="fas fa-calendar me-2"></i>
                            <span class="me-3"><?php echo e(date('d/m/Y')); ?></span>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h2 class="mb-0 fw-bold"><?php echo e($stats['atenciones_hoy'] ?? 0); ?></h2>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h2 class="mb-0 fw-bold"><?php echo e($stats['cola_espera'] ?? 0); ?></h2>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h2 class="mb-0 fw-bold"><?php echo e($stats['tramites_completados'] ?? 0); ?></h2>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h2 class="mb-0 fw-bold"><?php echo e($stats['tiempo_promedio'] ?? 15); ?></h2>
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="card h-100 border-warning">
                                <div class="card-body text-center">
                                    ...
                                    <a href="<?php echo e(route('inspecciones.create')); ?>" class="btn btn-warning">Crear Inspección</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <div class="card h-100 border-success">
                                <div class="card-body text-center">
                                    ...
                                    <a href="<?php echo e(route('fiscalizador.actas-contra')); ?>" class="btn btn-success">Ver Actas</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                ?>
                                <?php $__empty_1 = true; $__currentLoopData = $inspecciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inspeccion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td><strong>#<?php echo e($inspeccion->id); ?></strong></td>
                                    <td><?php echo e($inspeccion->numero_inspeccion ?? 'N/A'); ?></td>
                                    <td><?php echo e($inspeccion->tipo_inspeccion ?? 'General'); ?></td>
                                    <td>
                                        <?php if($inspeccion->estado == 'completada'): ?>
                                            <span class="badge bg-success">Completada</span>
                                        <?php elseif($inspeccion->estado == 'pendiente'): ?>
                                            <span class="badge bg-warning">Pendiente</span>
                                        <?php else: ?>
                                            <span class="badge bg-info"><?php echo e($inspeccion->estado); ?></span>
                                        <?php endif; ?>
                                    </td>
                                    <td><?php echo e($inspeccion->created_at ?? 'N/A'); ?></td>
                                    <td>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-2 col-sm-4 col-6 mb-3">
                            <a href="<?php echo e(route('inspecciones.index')); ?>" class="btn btn-outline-warning w-100 h-100 d-flex flex-column align-items-center justify-content-center text-decoration-none" style="min-height: 80px;">
                                <i class="fas fa-clipboard-check fa-2x mb-2"></i>
                                <span>Inspecciones</span>
                            </a>
                        </div>
                        <div class="col-md-2 col-sm-4 col-6 mb-3">
                            <a href="<?php echo e(route('fiscalizador.actas-contra')); ?>" class="btn btn-outline-primary w-100 h-100 d-flex flex-column align-items-center justify-content-center text-decoration-none" style="min-height: 80px;">
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Login-app\resources\views\backup-roles-sep-2025\ventanilla\dashboard.blade.php ENDPATH**/ ?>