                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="profile-name" value="<?php echo e(auth()->user()->name); ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="profile-username" class="form-label">Usuario</label>
                                <input type="text" class="form-control" id="profile-username" value="<?php echo e(auth()->user()->username); ?>" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control" id="profile-email" value="<?php echo e(auth()->user()->email); ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="profile-role" class="form-label">Rol</label>
                                <input type="text" class="form-control" id="profile-role" value="<?php echo e(ucfirst(auth()->user()->role)); ?>" readonly>
                            </div>
                        </div>
                    </div>
                    <hr>
        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <span class="badge bg-<?php echo e(auth()->user()->status === 'approved' ? 'success' : 'warning'); ?>">
                ...
                <div class="mb-3">
                    ...
                    <small class="text-muted"><?php echo e(auth()->user()->created_at->format('d/m/Y H:i')); ?></small>
                </div>
                <?php if(auth()->user()->approved_at): ?>
                <div class="mb-3">
                    <strong>Fecha de Aprobación:</strong><br>
                    <small class="text-muted"><?php echo e(auth()->user()->approved_at->format('d/m/Y H:i')); ?></small>
                </div>
                <?php endif; ?>
                <div class="mb-3">
...
function resetProfileForm() {
    document.getElementById('profile-name').value = '<?php echo e(auth()->user()->name); ?>';
    document.getElementById('profile-email').value = '<?php echo e(auth()->user()->email); ?>';
    document.getElementById('current-password').value = '';
    document.getElementById('new-password').value = '';
    document.getElementById('confirm-password').value = '';
}
</script><?php /**PATH C:\xampp\htdocs\Login-app\resources\views\dashboard\sections\profile.blade.php ENDPATH**/ ?>