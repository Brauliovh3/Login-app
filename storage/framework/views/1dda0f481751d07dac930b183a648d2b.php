<?php $__env->startSection('title', 'Dashboard Inspector'); ?>
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <?php echo e($stats['total_infracciones'] ?? 0); ?>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <?php echo e($stats['infracciones_resueltas'] ?? 0); ?>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <?php echo e($stats['infracciones_pendientes'] ?? 0); ?>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <?php echo e($stats['total_actas'] ?? 0); ?>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <?php echo e($stats['actas_procesadas'] ?? 0); ?>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <?php echo e($stats['actas_pendientes'] ?? 0); ?>
                        ...
                        <?php $__currentLoopData = $notifications->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div>
                                    ...
                                    <div class="text-gray-800"><?php echo e(Str::limit($notification->message, 60)); ?></div>
                                </div>
                            </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-3 col-md-6 mb-3">
                            <a href="<?php echo e(route('inspector.nueva-inspeccion')); ?>" class="btn btn-primary btn-lg w-100" style="background: linear-gradient(135deg, #ff8c00, #e67e22); border: none;">
                                <i class="fas fa-plus-circle mb-1"></i><br>
                                <small>Nueva Inspección</small>
                            </a>
                        </div>
                        <div class="col-lg-3 col-md-6 mb-3">
                            <a href="<?php echo e(route('inspector.inspecciones')); ?>" class="btn btn-outline-primary btn-lg w-100" style="border-color: #ff8c00; color: #ff8c00;">
                                <i class="fas fa-list mb-1"></i><br>
                                <small>Mis Inspecciones</small>
                            </a>
                        </div>
                        <div class="col-lg-3 col-md-6 mb-3">
                            <a href="<?php echo e(route('inspector.vehiculos')); ?>" class="btn btn-outline-primary btn-lg w-100" style="border-color: #ff8c00; color: #ff8c00;">
                                <i class="fas fa-car mb-1"></i><br>
                                <small>Vehículos</small>
                            </a>
                        </div>
                        <div class="col-lg-3 col-md-6 mb-3">
                            <a href="<?php echo e(route('inspector.reportes')); ?>" class="btn btn-outline-primary btn-lg w-100" style="border-color: #ff8c00; color: #ff8c00;">
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Login-app\resources\views\backup-roles-sep-2025\inspector\dashboard.blade.php ENDPATH**/ ?>