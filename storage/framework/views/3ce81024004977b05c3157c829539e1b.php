                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="fecha_intervencion" value="<?php echo e(date('Y-m-d')); ?>" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="time" class="form-control" id="hora_intervencion" value="<?php echo e(date('H:i')); ?>" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
...
function limpiarFormulario() {
    ...
    document.getElementById('fecha_intervencion').value = '<?php echo e(date('Y-m-d')); ?>';
    document.getElementById('hora_intervencion').value = '<?php echo e(date('H:i')); ?>';
}

function previsualizarActa() {
    showNotification('Vista previa disponible próximamente', 'info');
}
</script><?php /**PATH C:\xampp\htdocs\Login-app\resources\views\dashboard\sections\fiscalizador\actas.blade.php ENDPATH**/ ?>