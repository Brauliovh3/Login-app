            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0">
                    ...
                    <tbody id="usuariosTableBody">
                        ...
                        <tr>
                            <td><strong><?php echo e($usuario->username ?? $usuario->email); ?></strong></td>
                            <td><?php echo e($usuario->email); ?></td>
                            <td><?php echo e($usuario->name ?? 'No especificado'); ?></td>
                            <td>
                                <span class="badge bg-info"><?php echo e(ucfirst($usuario->role ?? 'Sin rol')); ?></span>
                            </td>
                            <td>
                                <span class="badge bg-<?php echo e($usuario->status === 'active' ? 'success' : 'danger'); ?>">
                                    <?php echo e($usuario->status === 'active' ? 'Activo' : 'Inactivo'); ?>

                                </span>
                            </td>
                            <td><?php echo e($usuario->updated_at ? $usuario->updated_at->format('d/m/Y H:i') : 'Nunca'); ?></td>
                            <td>
                                ...
                                <button class="btn btn-sm btn-outline-danger" title="Bloquear/Desbloquear">
                                    <i class="fas fa-<?php echo e($usuario->status === 'active' ? 'lock' : 'unlock'); ?>"></i>
                                </button>
                            </td>
                        </tr>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Login-app\resources\views/administrador/gestionar-usuarios.blade.php ENDPATH**/ ?>