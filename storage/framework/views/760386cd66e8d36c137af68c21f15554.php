...
?>
                    ...
                    <div class="card-body p-4">
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto text-end">
                                <a href="<?php echo e(route('users.index')); ?>" class="btn btn-outline-light">Gestionar Usuarios</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="card h-100">
                    <div class="card-body text-center">
                        ...
                        <a href="<?php echo e(route('users.index')); ?>" class="btn btn-primary">Gestionar</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
    ...
    <?php elseif($role === 'ventanilla'): ?>
            ...
            <div class="col-md-3">
                <div class="card text-white bg-drtc-orange">
                    <div class="card-body text-center">
                        ...
                        <h3><?php echo e($stats['atenciones_hoy'] ?? 0); ?></h3>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card text-white bg-warning">
                    <div class="card-body text-center">
                        <h6>En Cola</h6>
                        <h3><?php echo e($stats['cola_espera'] ?? 0); ?></h3>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card text-white bg-success">
                    <div class="card-body text-center">
                        <h6>Completados</h6>
                        <h3><?php echo e($stats['tramites_completados'] ?? 0); ?></h3>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card text-white bg-info">
                    <div class="card-body text-center">
                        ...
                        <h3><?php echo e($stats['tiempo_promedio'] ?? 15); ?>m</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row mb-4">
            <div class="col-md-6">
                <a href="<?php echo e(route('inspecciones.create')); ?>" class="btn btn-warning w-100">Nueva Inspección</a>
            </div>
            <div class="col-md-6">
                <a href="<?php echo e(route('fiscalizador.actas-contra')); ?>" class="btn btn-success w-100">Ver Actas</a>
            </div>
        </div>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Login-app\resources\views\backup-roles-sep-2025\fiscalizador\actas-contra.blade.php ENDPATH**/ ?>