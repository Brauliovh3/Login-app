    ...
    <div class="modal-content-wrapper">
        ...
        <div class="modal-body-custom">
            <form id="form-nueva-acta" action="/actas" method="POST">
                ...
                <input type="hidden" name="inspector_principal" value="<?php echo e(Auth::check() ? Auth::user()->name : 'Sistema'); ?>">
...
</script><?php /**PATH C:\xampp\htdocs\Login-app\resources\views\partials\modulos\actas-contra.blade.php ENDPATH**/ ?>