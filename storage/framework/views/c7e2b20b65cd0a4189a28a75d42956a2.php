                        ...
                        <div>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-2" style="background: none; padding: 0;">
                                    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.dashboard')); ?>" style="color: rgba(255,255,255,0.8); text-decoration: none;">Dashboard</a></li>
                ...
                <div class="card-header border-0" style="background: linear-gradient(135deg, #ff8c00, #e67e22); color: white;">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <small style="color: rgba(255, 255, 255, 0.9);">
                            <i class="fas fa-info-circle me-1"></i>Total: <?php echo e($users->total()); ?> usuarios
                        </small>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Login-app\resources\views/users/index.blade.php ENDPATH**/ ?>