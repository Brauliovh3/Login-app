            ...
            <div class="col-md-6 mb-3">
                <div class="card h-100 border-danger">
                    <div class="card-body text-center">
                        ...
                        <a href="<?php echo e(route('admin.super.index')); ?>" class="btn btn-danger">Acceder</a>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Login-app\resources\views\dashboard_restored.blade.php ENDPATH**/ ?>