        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <?php if(auth()->user()->role === 'inspector' || auth()->user()->isAdmin() || auth()->user()->isSuperAdmin()): ?>
                    <div class="col-md-4 mb-3">
...
</script><?php /**PATH C:\xampp\htdocs\Login-app\resources\views\dashboard\sections\dashboard.blade.php ENDPATH**/ ?>