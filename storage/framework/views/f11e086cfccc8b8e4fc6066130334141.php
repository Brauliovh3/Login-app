...
<?php $__env->startSection('title', 'Gestión de Usuarios - Administrador DRTC'); ?>
        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex gap-2">
                    <span class="badge bg-warning fs-6"><?php echo e($pendingUsers->count()); ?> Pendientes</span>
                    <span class="badge bg-danger fs-6"><?php echo e($rejectedUsers->count()); ?> Rechazados</span>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card approval-card">
                <div class="card-header bg-warning text-dark">
                    <h5 class="mb-0">
                        ...
                        Solicitudes Pendientes de Aprobación (<?php echo e($pendingUsers->count()); ?>)
                    </h5>
                </div>
                <div class="card-body">
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-3">
                                        ...
                                        <div class="flex-grow-1">
                                            <h6 class="mb-1 fw-bold"><?php echo e($user->name); ?></h6>
                                            <small class="text-muted"><?php echo e($user->username); ?></small> <!-- ← Quitar el @ -->
                                        </div>
                                        <span class="status-badge bg-warning text-dark">Pendiente</span>
                                    </div>

                                    <div class="mb-3">
                                        <p class="mb-1"><i class="fas fa-envelope me-2 text-muted"></i><?php echo e($user->email); ?></p>
                                        <p class="mb-1"><i class="fas fa-user-tag me-2 text-muted"></i><?php echo e(ucfirst($user->role)); ?></p>
                                        <p class="mb-0"><i class="fas fa-calendar me-2 text-muted"></i><?php echo e($user->created_at->format('d/m/Y H:i')); ?></p>
                                    </div>
                                    ...
                                    <div class="d-flex gap-2">
                                        <button type="button"
                                            ...
                                            data-user-role="<?php echo e(ucfirst($user->role)); ?>"
                                            data-user-initials="<?php echo e(strtoupper(substr($user->name, 0, 2))); ?>">
                                            <i class="fas fa-check me-1"></i>Aprobar
                                        </button>
                                        <button type="button" class="btn btn-reject flex-fill" onclick="showRejectModal(<?php echo e($user->id); ?>, '<?php echo e($user->name); ?>')">
            ...
            <div class="card approval-card">
                <div class="card-header bg-danger text-white">
                    <h5 class="mb-0">
                        ...
                        Solicitudes Rechazadas Recientes (<?php echo e($rejectedUsers->count()); ?>)
                    </h5>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <small class="text-muted"><?php echo e($user->username); ?></small> <!-- ← Quitar el @ también aquí -->
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <small class="text-muted"><?php echo e(Str::limit($user->rejection_reason, 50)); ?></small>
                                    </td>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Login-app\resources\views/admin/user-approval/index.blade.php ENDPATH**/ ?>